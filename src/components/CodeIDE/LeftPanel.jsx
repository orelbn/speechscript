            ...
            <Box sx={{display: 'flex', justifyContent: "center", marginTop: 2}}>
                <Box sx={{display: 'flex', justifyContent: 'space-between'}}>
                    <Box sx={{display: 'flex', flexDirection: 'column', height: "15vh", marginRight: 5, width:170}}>
                        <Button  variant="contained" onClick={handleOpenAIfetch} sx={{height: 50}}>Execute</Button>
                        <Button className={recording && "recording"} color="error" variant="contained" onClick={handleRecordSpeech} sx={{height: 50, marginTop: 3}}>Record</Button>
                    </Box>
